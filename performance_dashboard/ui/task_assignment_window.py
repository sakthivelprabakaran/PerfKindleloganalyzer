...
class TaskAssignmentDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.suite_combo.addItems(["P0", "P1", "P2", "Adhoc"])
...
class TaskAssignmentWindow(QWidget):
    ...
    def create_assignments_tab(self):
        ...
        self.assignments_table.setHorizontalHeaderLabels([
            "ID", "Project", "Suite", "Executor", "Auditor", "Status"
        ])
    ...
    def populate_assignments_table(self, data):
        ...
        for i, row in enumerate(data):
            ...
            self.assignments_table.setItem(i, 3, executor_item)
            self.assignments_table.setItem(i, 4, auditor_item)
            self.assignments_table.setItem(i, 5, status_item)
